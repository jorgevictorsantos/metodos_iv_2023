...
Pela função `dim()`, que nos dá as dimensões da base de dados, observamos que há 645 municípios no estado de São Paulo. Ao filtrar a observação com menor número de habitantes, vemos que o menor município de São Paulo, em relação à população, é Borá, com 838 habitantes.
