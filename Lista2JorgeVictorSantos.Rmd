...
cat('E[aX + bY] = ', mean(a * data$Renda + b * data$Horas_trabalhadas, na.rm = T), '\n') # E[aX + bY]

cat('a*E[X] + b*E[Y] =', (a * mean(data$Renda, na.rm = T)) + (b * mean(data$Horas_trabalhadas, na.rm = T)),'\n') # aE[X] + bE[Y]

# Assim:

cat('E[aX + bY] == a*E[X] + b*E[Y]', mean(a * data$Renda + b * data$Horas_trabalhadas, na.rm = T) == (a * mean(data$Renda, na.rm = T)) + (b *mean(data$Horas_trabalhadas, na.rm = T)))
